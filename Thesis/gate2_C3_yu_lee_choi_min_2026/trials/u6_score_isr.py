"""Source ISR specificity extension; existing trials remain unchanged."""
...
def main():
    ...
    out=PAPER/'trials/u6_isr_extension';cache=PAPER/'cache/u6_isr_extension';cache.mkdir(parents=True,exist_ok=True)
    ...
    helper_path=ROOT/'Thesis/epithelial_state_specificity/run_es1.py';loader=importlib.util.spec_from_file_location('existing_es1_readonly',helper_path);helper=importlib.util.module_from_spec(loader);loader.loader.exec_module(helper)
