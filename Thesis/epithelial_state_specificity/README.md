...
```powershell
python Thesis/epithelial_state_specificity/test_es1.py
python Thesis/epithelial_state_specificity/run_es1.py
python Thesis/epithelial_state_specificity/verify_es1.py
python Thesis/epithelial_state_specificity/run_es1.py --replot
```
