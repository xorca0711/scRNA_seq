...
Outputs (Research Article/gate1_01_niethamer_2025/trials/g0_gsea_feasibility/):
...
CARDOSO = REPO / "Research Article" / "gate2_05_cardoso_2026" / "trials"
CHOI = REPO / "Research Article" / "gate1_02_choi_2020" / "trials"
MULTI = REPO / "Research Article" / "gate1_02_choi_2020" / "datp_epigenetics" / "trials"
...
def main() -> int:
    ...
    add("GSE178360", "Kadur Lakshminarasimha Murthy et al. 2022", "human", "donor", {"healthy donors": 3}, True,
        ...
        "no contrast exists in the deposit", "Research Article/ungated_murthy_2022/GSE178360/README.md")
