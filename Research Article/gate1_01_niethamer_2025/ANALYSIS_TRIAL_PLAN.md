...
hygiene; no interferon or influenza narrative). **Stage 2** records follow-up designs and their execution status,
including completed, gated and unrun work. Every Stage 1 step has a run record with its rules
...
|---|---|---|---|---|
| 0.1 | What is in the deposit, and what QC does each library need | Raw-data scan; per-sample MAD thresholds with recorded rationales; Scrublet per capture | `analysis/raw_data_inventory.*`, `Research Article/gate1_01_niethamer_2025/GSE262927/qc/` | Validated (counts checked by `validate_repository.py`) |
| 0.2 | Does blind clustering recover the deposited cell types | 162,175 cells, 29 Leiden clusters, no batch correction (root decision 2); deposited labels held out and used only as an answer key | `Research Article/gate1_01_niethamer_2025/GSE262927/figures/umap/`, `tables/cluster_vs_author_celltype_fraction.csv` | Validated (median purity 0.947) |
...
| 0.4 | Which epithelial states are present | Epithelial sub-analysis, 16 subclusters | `Research Article/gate1_01_niethamer_2025/GSE262927/epithelial_subanalysis/` | Descriptive only |
| 0.5a | Is the AT2 to Krt8-high transitional to AT1 axis a real ordering | PAGA plus diffusion pseudotime rooted in AT2 on the 25-sample cohort; labels held out | `Research Article/gate1_01_niethamer_2025/GSE262927/regeneration_focus/` | displaced to [`archive/DISPLACED.md`](../../archive/DISPLACED.md) (established elsewhere); artefacts unchanged |
| 0.5b | Does the injury capillary state resolve | Capillary subset reclustered within compartment; per-animal abundance by day | `Research Article/gate1_01_niethamer_2025/GSE262927/regeneration_focus/` | Validated (iCAP 2.0% at baseline to 37.5% at 25 dpi to 21.7% at 366 dpi; has not resolved by 366 dpi) |
| 0.6 | Where does the injury capillary state come from | 8-sample Cre cohort; trace rule reproduces the deposited calls at 100% | `Research Article/gate1_01_niethamer_2025/GSE262927/lineage_tracing_cohort/` | Validated for the Kit line (33 to 53% per animal); CAP2 lines uninformative |
...
- **Artefacts.** [`Research Article/gate1_01_niethamer_2025/GSE262927/phase_timecourse/`](GSE262927/phase_timecourse/README.md)
...
- **Artefacts.** [`Research Article/gate1_01_niethamer_2025/GSE262927/myeloid_focus/`](GSE262927/myeloid_focus/README.md)
...
- **Artefacts.** [`Research Article/gate1_01_niethamer_2025/GSE262927/myeloid_focus/amac_origin/`](GSE262927/myeloid_focus/amac_origin/README.md)
...
- **Artefacts.** [`Research Article/gate1_01_niethamer_2025/GSE262927/myeloid_focus/batch_sensitivity/`](GSE262927/myeloid_focus/batch_sensitivity/README.md)
...
## Stage 2. Follow-up designs and execution status
