...
def external(genes,modules,rows,gene_rows,retention,inputs):
    ...
    path=ROOT/'Research Article/gate1_01_niethamer_2025/GSE262927/processed/postQC.h5ad'
    units=ROOT/'Research Article/gate1_01_niethamer_2025/trials/w1_amac_pseudobulk_de/w1_units.csv'
