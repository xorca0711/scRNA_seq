...
REPO = HERE.parents[2]
MOUSE = REPO / "Research Article" / "gate1_01_niethamer_2025" / "GSE262927"
HUMAN = REPO / "Research Article" / "ungated_murthy_2022" / "GSE178360"
...
def main() -> None:
    ...
    result["inputs"] += [
        "Research Article/gate1_01_niethamer_2025/GSE262927/tables/cluster_vs_author_celltype_counts.csv",
        "Research Article/gate1_01_niethamer_2025/GSE262927/tables/cluster_by_sample_counts.csv",
        "Research Article/gate1_01_niethamer_2025/GSE262927/tables/cluster_annotation_proposals.csv",
        "Research Article/gate1_01_niethamer_2025/GSE262927/regeneration_focus/tables/transitional_abundance_per_sample.csv",
    ...
    result["inputs"].append("Research Article/ungated_murthy_2022/GSE178360/tables/cluster_by_sample_counts.csv")
