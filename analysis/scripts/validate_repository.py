...
def check_machine_readable_files(result: Validation) -> None:
    ...
    result.require(
        not (REPO / "Research Article/gate1_01_niethamer_2025/GSE262927/inventory/raw_files.json").exists(),
        "obsolete dataset-specific raw-data inventory still exists",
    )


def check_headline_results(result: Validation) -> None:
    mouse = read_json("Research Article/gate1_01_niethamer_2025/GSE262927/logs/decisions.json")
    human = read_json("Research Article/ungated_murthy_2022/GSE178360/logs/decisions.json")
    ...
    proposals = read_csv("Research Article/gate1_01_niethamer_2025/GSE262927/tables/cluster_annotation_proposals.csv")
    ...
    fractions = read_csv("Research Article/gate1_01_niethamer_2025/GSE262927/tables/cluster_vs_author_celltype_fraction.csv")
    ...
    transitional = median_by(
        read_csv("Research Article/gate1_01_niethamer_2025/GSE262927/regeneration_focus/tables/transitional_abundance_per_sample.csv"),
    ...
    icap = median_by(
        read_csv("Research Article/gate1_01_niethamer_2025/GSE262927/regeneration_focus/tables/icap_abundance_per_sample.csv"),
        "day", "pct",
    )
    ...
    tracing = read_csv(
        "Research Article/gate1_01_niethamer_2025/GSE262927/lineage_tracing_cohort/tables/icap_tracing_by_cre_line.csv"
    )
    kit_rates = [
