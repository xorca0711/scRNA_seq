...
| Not established | The paper's epithelium-to-fibroblast axis shows no donor-level coupling in human fibrosis that 22 donors could detect (rho 0.348, p = 0.112, against a detectable floor of about 0.43) | [`gate2_05_cardoso_2026/`](Thesis/gate2_05_cardoso_2026/ANALYSIS_TRIAL_PLAN.md) |
| Validated (decision record) | A sequencing-depth control is load-bearing in donor-level correlation work: the only significant correlation in that test was a control pair whose two variables both track depth | [`gate2_05_cardoso_2026/`](Thesis/gate2_05_cardoso_2026/ANALYSIS_TRIAL_PLAN.md) |
| Descriptive only, pending | The Areg-high contaminant in the mesenchymal sort is a mixture, about four parts regenerative-like to four parts AT2, rather than a single state | [`gate2_05_cardoso_2026/`](Thesis/gate2_05_cardoso_2026/DIVERGENCES_AND_NEXT.md) |
...
| Descriptive only, pending | The deposit behind the paper that defines the regenerative-like state has one library per condition too, so no contrast in it is testable; six of its eight matrices are raw barcode whitelists and its lineage reporter is not a counted feature | [`Thesis/gate1_02_choi_2020/`](Thesis/gate1_02_choi_2020/ANALYSIS_TRIAL_PLAN.md) |
| Descriptive only, pending | From that deposit, four of the paper's five states, the DATP time course (0.3, 18.2 and 6.3 percent of lineage-labelled cells at PBS, day 14 and day 28), the AT2 to DATP to AT1 ordering inside one library, DATP's p53, arrest, hypoxia and interferon-gamma programmes, and IL-1beta's shift of the organoid epithelium (78 percent AT2 to 87 percent DATP-marker cells) all reproduce blind as descriptions | [`Thesis/gate1_02_choi_2020/`](Thesis/gate1_02_choi_2020/ANALYSIS_TRIAL_PLAN.md) |
| Not established | The paper's primed AT2 state does not separate as a cluster in vivo or in organoids; the organoid cluster the paper calls 77 percent primed carries the DATP markers with its AT2 identity genes intact | [`Thesis/gate1_02_choi_2020/`](Thesis/gate1_02_choi_2020/ANALYSIS_TRIAL_PLAN.md) |
| Retracted-superseded | The first annotation rule missed the AT1 cluster and the organoid stromal cluster because every cluster in a lineage-sorted AT2 library detects Sftpc; both outcomes stand and corrected passes sit beside them with no threshold moved | [`Thesis/gate1_02_choi_2020/`](Thesis/gate1_02_choi_2020/trials/README.md) |
| Descriptive only, pending | DATP is not a doublet cluster: mean Scrublet score 0.05 and an AT2-plus-AT1 co-detection (0.24) intermediate between AT2 (0.01) and AT1 (0.74) | [`Thesis/gate1_02_choi_2020/`](Thesis/gate1_02_choi_2020/ANALYSIS_TRIAL_PLAN.md) |
