...
| A10 | [Organoid growth outcome](A10_organoid_growth_outcome/README.md) | Analysis run on 885 wells: both increments inconclusive, the epithelial one below the declared margin, and the baseline does not transfer between units; assay validation passes |
