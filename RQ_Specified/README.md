...
| A2 | [AREG source delivery](A2_areg_source_delivery/README.md) | Both legs complete: the Areg arm does not move and its null is bounded by an unremoved autocrine source; epithelial Itgb6 moves by -0.938 log2 CPM in three of three readable units; the donor-level leg is refused by the C51 depth rule; delivery versus abundance remains untested |
