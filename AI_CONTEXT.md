...
pitfalls_for_ai_assistants:
  ...
  - "The .venv-x64 environment was rebuilt on 2026-09-20 after its base interpreter, which uv had placed under a tmp directory, was deleted; every scanpy, leidenalg, numba, torch and liana trial stopped running and nothing recorded what had been installed. Its exact contents are now tracked in analysis/config/requirements-x64.txt with the rebuild recipe in its header. Python 3.12.13, win-amd64, 120 distributions. The interpreter now lives under uv's durable default, AppData/Roaming/uv/python, not under any tmp path."
