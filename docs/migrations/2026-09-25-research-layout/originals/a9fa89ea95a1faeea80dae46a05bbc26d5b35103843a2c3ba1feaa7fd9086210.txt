...
& $python Thesis/gate1_03_nabhan_2018/source_reproduction/reproduce.py
& $python -m unittest discover -s Thesis/gate1_03_nabhan_2018/source_reproduction -p test_reproduction.py
& $python Thesis/gate1_03_nabhan_2018/source_reproduction/verify_outputs.py
```
