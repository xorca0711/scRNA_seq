...
| Paper notes, contracts, inference and galleries | `Thesis/<paper>/` | Preserve the paper-specific source evidence, scripts, tables and figure gallery |
| Cross-study specificity analysis | `Thesis/epithelial_state_specificity/` | Existing substantive analysis module, referenced by the global questions |
...
| Reading order and paper status | [Thesis/ROADMAP.json](../Thesis/ROADMAP.json), [Thesis/README.md](../Thesis/README.md) | Stable paper identifiers differ from the reading sequence; update the two views together |
...
`ROADMAP.json` paper `folder` values are relative to `Thesis/`, without a
